...
update_dataset_array () {
    ...
    DATASETS[mur-test-local/MUR25/20190101090000-JPL-L4_GHRSST-SSTfnd-MUR25-GLOB-v02.0-fv04.2.nc]="1 ${SINGLE_GRANULE_LOCAL_LOG}"
    DATASETS[mur-test-local/MUR/20190101090000-JPL-L4_GHRSST-SSTfnd-MUR-GLOB-v02.0-fv04.1.nc]="1 ${SINGLE_GRANULE_LOCAL_LOG}"
